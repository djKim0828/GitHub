    ...
    public class DataWriter
    {
        ...
        private void Write(WriteLevel level, string message)
        {
            ...
            try
            {
                ...
                writeData.ThreadId = Thread.CurrentThread.ManagedThreadId;
                writeData.StackFrams = stackTrace.GetFrames();
        ...
        public class WriteDataForFile
        {
            ...
            public WriteDataForFile(WriteData writeData)
            {
                ...
                StackFrams = GetCaller(writeData.StackFrams);
                ThreadID = writeData.ThreadId;
