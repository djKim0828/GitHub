...
using System.Web.Script.Serialization; // Reference에 System.Web.Extensions 추가하여 사용
...
namespace QueueTest
{
    ...
    public class Logger
    {
        ...
        public static void Alarm(string log, params object[] objects)
        {
            ...
            _instance.Write(Level.ALARM, _instance.GetLogString(log, objects));
        }
        ...
        public static void Debug(string log, params object[] objects)
        {
            ...
            _instance.Write(Level.DEBUG, _instance.GetLogString(log, objects));
        }
        ...
        public static void Error(string log, params object[] objects)
        {
            ...
            // Todo : 개발시에 확인을 위하여 
            System.Windows.Forms.MessageBox.Show(_instance.GetLogString(log, objects));

            _instance.Write(Level.ERROR, _instance.GetLogString(log, objects));
        }
        ...
        public static void Exception(Exception exception)
        {
            ...
            _instance.Write(Level.ERROR, exception.ToString());
        }
        ...
        public static void Fatal(string log, params object[] objects)
        {
            ...
            _instance.Write(Level.FETAL, _instance.GetLogString(log, objects));
        }
        ...
        public static void Infomation(string log, params object[] objects)
        {
            ...
            _instance.Write(Level.INFO, _instance.GetLogString(log, objects));
        }
        ...
        public static void Warning(string log, params object[] objects)
        {
            ...
            _instance.Write(Level.WARNING, _instance.GetLogString(log, objects));
        }
        ...
        public class LogData
        {
            ...
            public string GetDetailInfo()
            {
                ...
                sb.AppendLine("LogTime : " + LogTime);
                sb.AppendLine("LogLevel : " + LogLevel.ToString());
                sb.AppendLine("ThreadID : " + ThreadId.ToString());
                sb.AppendLine("StackFrams : " + StackFrams);
