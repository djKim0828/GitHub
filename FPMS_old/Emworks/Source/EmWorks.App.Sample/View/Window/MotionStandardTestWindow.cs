...
namespace EmWorks.App.Sample.View.Window
{
    public partial class MotionStandardTestWindow : Form
    {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            _motion = new EncMotionStandard(filePath, chkSim.Checked); // 객체 생성시에 설정파일(Json)을 파라미터로 넣으면 자동으로 Load된다.
        ...
        private void MotionStandardTestWindow_Load(object sender, EventArgs e)
        {
            txtPath.Text = HomeDir() + @"\Config\Tag\EncMotionStandard.json";
