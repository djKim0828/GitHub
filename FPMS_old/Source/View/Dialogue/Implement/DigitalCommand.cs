...
namespace FPMS.E2105_FS111_121
{
    ...
    public class DigitalCommand : EmWorks.View.DigitalCommandDialog
    {
        ...
        public void Toggle()
        {
            ...
            while (_toggle == true)
            {
                _tempTag.Is = _tempTag.n == 0 ? Idx.DigitalValue.Enable : Idx.DigitalValue.Disable;
        ...
        private void DigitalCommand_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (_tempTag.Identity.IoType != EmWorks.Lib.Core.Tag.Idx.IoType.Output || _tempTag.Identity.DataType != EmWorks.Lib.Core.Tag.Idx.DataType.Int)
            {
            ...
            {
                lblDlgTitle.Content = _tempTag.Name;
            }
        }
