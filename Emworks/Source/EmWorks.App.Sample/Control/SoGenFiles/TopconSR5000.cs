...
namespace EmWorks.App.Sample
{
    public class Topcon_SR5000
    {
        ...
        public EmTopconSR5000 _device;  // Todo : 사용할 Device 로 변경 必

        #endregion Fields

        #region Constructors

        public Topcon_SR5000(string filePath, bool isSimulationMode)
        {
            _filePath = filePath;
            ...
            _device = new EmTopconSR5000(_tags, isSimulationMode); // Todo : 사용할 Device 로 변경 必
