...
namespace EmWorks.Lib.Common
{
    ...
    public class LogData
    {
        ...
        private string GetSubPath(LogData data)
        {
            ...
            string dateFileName = _DateTime.ToString(_dateFileNameFormat, CultureInfo.InvariantCulture);
            string dateFolderPath = _DateTime.ToString(_dateFolderPathFormat, CultureInfo.InvariantCulture);
