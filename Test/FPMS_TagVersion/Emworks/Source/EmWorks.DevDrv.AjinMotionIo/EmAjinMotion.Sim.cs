...
namespace EmWorks.DevDrv.AjinMotionIo
{
    public partial class EmAjinMotion
    {
        ...
        private void Homing(Tag commandTag)
        {
            ...
            xTag = GetxTag(commandTag.Identity.Unit, ExeCmd.SignalBusy);
            xTag.Is = 0;
        ...
        private void RunSimCommand(Tag commandTag)
        {
            ...
            else if (commandTag.Identity.IoType == Tag.Idx.IoType.Output)
            {
                ...
                CheckHome(commandTag);
            }
        }

        private void CheckHome(Tag commandTag)
        {
            ...
            Tag xHomeTag = GetxTag(commandTag.Identity.Unit, ExeCmd.SignalHome);
            if (xActPosTag.Is.ToString() == "0")
            {
                xHomeTag.Is = 1;
            }
            else
