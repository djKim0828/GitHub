...
namespace FPMS.E2105_FS111_121
{
    ...
    /// Class Name : <see cref="KeyenceIL"/>
    /// Author : Andrew, Yoon
    /// Description : object detail description.
    /// </summary>
    public class KeyenceIL : EmWorks.View.KeyenceIL100Component
    {
        #region Fields

        private bool _isLoop;
        private System.Collections.Generic.Dictionary<string, Tag> _keyenceIL100Tags;
        private int _locale;
        ...
        private void BtnOffLeaser_Click(object sender, System.Windows.RoutedEventArgs e)
        {
        }

        private void BtnOnLeaser_Click(object sender, System.Windows.RoutedEventArgs e)
        {
        }
        ...
        private int RegistEvents()
        {
            ...
            btnOnLeaser.Click += BtnOnLeaser_Click;
            btnOffLeaser.Click += BtnOffLeaser_Click;
