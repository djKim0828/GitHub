...
{
    public class SR5000Stage : UserControl
    {
        #region Fields
        ...
        private SR5000StageComponent _uiComponent;
        ...
        /// </summary>
        public SR5000Stage(SR5000StageComponent uiComponent)
        {
        ...
        {
            if (Global._PmacZ5.sxDeviceMotion.Is == null ||
                        Global._PmacZ5.sxDeviceMotion.Is.ToString() == Idx.DigitalValue.Disable.ToString())
            {
                return false;
            }
        ...
        private void CheckStatus()
        {
            ...
            {
                // Sht X1
                Global._MotionControl.ChangStatus(_uiComponent.tgbServo, Global._PmacZ5.xMotionServoOn);
                Global._MotionControl.ChangStatus(_uiComponent.tgbAlarm, Global._PmacZ5.xMotionAlarmStatus, true);
                Global._MotionControl.ChangStatus(_uiComponent.tgbBusy, Global._PmacZ5.xMotionSignalBusy);
                Global._MotionControl.ChangStatus(_uiComponent.tgbNeg, Global._PmacZ5.xMotionSignalNegativeLimit, true);
                Global._MotionControl.ChangStatus(_uiComponent.tgbPos, Global._PmacZ5.xMotionSignalPositiveLimit, true);
                Global._MotionControl.ChangStatus(_uiComponent.tgbOrg, Global._PmacZ5.xMotionSignalInpos);
                Global._MotionControl.ChangeCurrentPosition(_uiComponent.sldMotion,
                                                            Global._PmacZ5.xMotionActual,
        ...
        {
            Global._MotionControl.GetMaxMinPosition(Idx.MotionAxisName.Z5,
                                                    out _maxPositon,
                                                    out _minPositon);
        }
