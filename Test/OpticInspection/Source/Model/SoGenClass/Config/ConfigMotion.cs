...
namespace EmWorks.App.OpticInspection
{
    public class ConfigMotion
    {
        ...
        private static ConfigMotion _instance;
        ...
        public ConfigMotion(string filePath)
        {
            LoadConfig(filePath);
        }
        ...
        private ConfigMotion()
        {
            ...
            LoadConfig(newPath + @"\Config\ConfigMotion.json");
        }
        ...
        public static void InitInstance(string filePath = "")
        {
            ...
            {
                _instance = new ConfigMotion(filePath);
            }
        }
