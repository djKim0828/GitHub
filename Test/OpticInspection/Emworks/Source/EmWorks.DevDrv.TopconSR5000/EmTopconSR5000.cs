...
namespace EmWorks.DevDrv.TopconSR5000
{
    public partial class EmTopconSR5000 : DriverBase
    {
        ...
        //Auto Spot
        private Sr5000Properties _sr5000Properties;
        ...
        public EmTopconSR5000(Dictionary<string, Tag> tags, bool isSimulation) : base(tags, isSimulation)
        {
            ...
            _sr5000Properties = new Sr5000Properties();
        }
        ...
        public override int Open(Tag commandTag)
        {
            try
            {
                ...
                // Update Open Tag
                UpdateTagByExeCmd(EmWorks.Lib.Core.Tag.Idx.IoType.StatusInput,
        ...
        public void ShowError(HsApiNet.Error errorCode, Tag commandTag, object value)
        {
            ...
            if (commandTag != null)
            {
                ...
                commandTag.Identity.ExeCmd, value);
            }
        }
        ...
        {
            string action = commandTag.Identity.ExeCmd;
        ...
        public class Sr5000Properties
        {
            ...
            public string measurementFilePath;

            public Sr5000Properties()
            {
                width = height = 0;
                min = max = yTh = 0;
            }
