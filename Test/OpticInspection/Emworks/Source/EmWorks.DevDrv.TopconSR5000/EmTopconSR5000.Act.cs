    ...
    public partial class EmTopconSR5000
    {
        ...
        public int Connect(Tag commandTag)
        {
            try
            {
                ...
                // Update Connect Tag
                UpdateTagByExeCmd(EmWorks.Lib.Core.Tag.Idx.IoType.Input,
                    commandTag.Identity.ExeCmd, OpenClose.Open);
                ...
                ReturnFailed:
                {
                    ...
                    UpdateTagByExeCmd(EmWorks.Lib.Core.Tag.Idx.IoType.Input,
                        commandTag.Identity.ExeCmd, OpenClose.Error);
        ...
        private SpotDef CreateSpotDef()
        {
            ...
            spotDef.rdm_spot_setting.auto_spot_setting[0].spot_shape = _sr5000Properties.shapeType == 0 ? AreaShapeType.SQUARE : AreaShapeType.CIRCLE;
            spotDef.rdm_spot_setting.auto_spot_setting[0].spot_size = new Size64f(_sr5000Properties.width,
                                                                                  _sr5000Properties.height);
            spotDef.rdm_spot_setting.auto_spot_setting[0].area_min = _sr5000Properties.min;
            spotDef.rdm_spot_setting.auto_spot_setting[0].area_max = _sr5000Properties.max;
            ...
            spotDef.rdm_spot_setting.auto_spot_setting[0].image_setting[0].threshold = Convert.ToSingle(_sr5000Properties.yTh);
        ...
        private void GetPseudoImage(Tag commandTag)
        {
            ...
            try
            {
                // Tag 초기화
                UpdateTagByExeCmd(EmWorks.Lib.Core.Tag.Idx.IoType.Input,
                    commandTag.Identity.ExeCmd, null);
        ...
        private void LoadMeasurement(Tag commandTag)
        {
            ...
            UpdateTagByExeCmd(EmWorks.Lib.Core.Tag.Idx.IoType.Input,
                commandTag.Identity.ExeCmd, FunctionResult.True);
        ...
        private void LoadRecipe(Tag commandTag)
        {
            ...
            try
            {
                string filePath = _sr5000Properties.recipeFilePath;//commandTag.Identity.Options.ToString();
        ...
        private void SaveRecipe(Tag commandTag)
        {
            ...
            catch
            {
                ...
                UpdateTagByExeCmd(EmWorks.Lib.Core.Tag.Idx.IoType.Input,
                    commandTag.Identity.ExeCmd, FunctionResult.False);
        ...
        private void SetProperty(Tag commandTag)
        {
            string propertyName = commandTag.Identity.ExeCmd.ToString();

            switch (propertyName)
            {
                case "MeasurementFilePath":
                    _sr5000Properties.measurementFilePath = commandTag.s;
                    break;
                case "RecipeFilePath":
                    _sr5000Properties.recipeFilePath = commandTag.s;
                    break;

                case "AutoSpotShapeType":
                    _sr5000Properties.shapeType = commandTag.n;
                    break;

                case "AutoSpotWidth":
                    _sr5000Properties.width = commandTag.d;
                    break;

                case "AutoSpotHeight":
                    _sr5000Properties.height = commandTag.d;
                    break;

                case "AutoSpotMin":
                    _sr5000Properties.min = commandTag.n;
                    break;

                case "AutoSpotMax":
                    _sr5000Properties.max = commandTag.n;
                    break;

                case "AutoSpotYTh":
                    _sr5000Properties.yTh = commandTag.n;
                    break;
            }
        }
