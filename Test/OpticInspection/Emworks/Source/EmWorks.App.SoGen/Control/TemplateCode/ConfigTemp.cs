...
namespace EmWorks.App.SoGen // Todo : 네임스페이스 확인 필요
{
    public class ConfigTemp
    {
        ...
        private static ConfigTemp _instance;
        ...
        public ConfigTemp(string filePath)
        {
            LoadConfig(filePath);
        }
        ...
        private ConfigTemp()
        {
            ...
            LoadConfig(newPath + @"\Config\ConfigTemp.json");
        }
        ...
        public static void InitInstance(string filePath = "")
        {
            ...
            {
                _instance = new ConfigTemp(filePath);
            }
        }
