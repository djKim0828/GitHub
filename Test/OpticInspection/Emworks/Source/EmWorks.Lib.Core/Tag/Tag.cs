    ...
    public class Tag : ITag
    {
            ...
            if (_isChanged)
            {
                ...
                else
                {
                    if (_idendity.IoType == (int)Idx.IoType.Input || _idendity.IoType == (int)Idx.IoType.StatusInput)
                        _onTagUpdate?.Invoke(this, new EventTagChangedArgs(this) { EventType = (int)Idx.EventType.Update }); // input tag update
        ...
        public class Idx
        {
            ...
            public class EventType
            {
                ...
                public const int OccurredAlarm = 3;
                public const int ReleasedAlarm = 4;
            }
